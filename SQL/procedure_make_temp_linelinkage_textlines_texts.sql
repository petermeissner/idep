DROP PROCEDURE IF EXISTS make_temp_linelinkage_textlines_texts ; 
delimiter #
CREATE PROCEDURE make_temp_linelinkage_textlines_texts()
  BEGIN
...
-- call make_temp_linelinkage_textlines_texts();
