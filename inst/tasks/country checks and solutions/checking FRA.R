...
require(idep)
get_ready()
setwd("Z:/Geschäftsordnungen/codingChanges/FRA/R files")
...
plot(apply(comp1, 1, text_dist))
# comp1[apply(comp1, 1, text_dist) > 2 ,]

plot(apply(comp2, 1, text_dist))
...
RESULTS$Afile <- str_replace(texts_names,
                             "\\.\\.",
                             "Z:/Geschäftsordnungen/codingChanges/FRA")[1]
RESULTS$Bfile <- str_replace(texts_names,
                             "\\.\\.",
                             "Z:/Geschäftsordnungen/codingChanges/FRA")[2]

if( is.null(RESULTS$comments) ) RESULTS$comments <- ""
