...
setwd("Z:/Geschäftsordnungen/CodingChanges/SWI/GRN/linked files")
fnames <- getwd() %.% "/" %.% sort(list.files(pattern="^CH"))
...
# select corpus file
corpus_file_select("Z:/Geschäftsordnungen/CodingCorpus/CorpusCoding SWI-GRN.Rdata")
corpus_file_full
corpus_file_fname
corpus_file_path
