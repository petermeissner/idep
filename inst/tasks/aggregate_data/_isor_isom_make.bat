...
R < isor.R                         > routs/isor.rout                         --vanilla || (PAUSE && EXIT /B 1)

R < isor_ext_pro_minmaj.R          > routs/isor_ext_pro_minmaj.Rout          --vanilla || (PAUSE && EXIT /B 1)
R < isor_ext_tsebelis.R            > routs/isor_ext_tsebelis.Rout            --vanilla || (PAUSE && EXIT /B 1)
R < isor_ext_erd_cabinet_ids.R     > routs/isor_ext_erd_cabinet_ids.Rout     --vanilla || (PAUSE && EXIT /B 1)
...
R < isom.R                         > routs/isom.rout                         --vanilla || (PAUSE && EXIT /B 1)
