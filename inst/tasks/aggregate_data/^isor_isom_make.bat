...
::CALL Rscript -e "library(knitr); knitr::knit2html('isor_codebook.Rmd')" 
::CALL Rscript -e "library(knitr); knitr::knit2html('isom_codebook.Rmd')" 
CALL Rscript -e "library(rmarkdown); render('isor_codebook.Rmd')" 
CALL Rscript -e "library(rmarkdown); render('isom_codebook.Rmd')" 
CALL Rscript -e "library(rmarkdown); render('isor_codebook_manuals.Rmd')" 
