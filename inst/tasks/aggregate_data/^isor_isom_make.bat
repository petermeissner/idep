...
REM CALL R < isor.R                         > routs/isor.rout                         --vanilla 
REM CALL R < isor_ext_pro_minmaj.R          > routs/isor_ext_pro_minmaj.Rout          --vanilla 
REM CALL R < isor_ext_tsebelis.R            > routs/isor_ext_tsebelis.Rout            --vanilla 
REM CALL R < isor_ext_erd_cabinet_ids.R     > routs/isor_ext_erd_cabinet_ids.Rout     --vanilla 
...
REM CALL R < isom.R                         > routs/isom.rout                         --vanilla 
