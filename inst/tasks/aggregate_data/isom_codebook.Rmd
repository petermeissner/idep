...
The variables of the ISORD dataset are extensively described in a seperate codebook (`isor_codebook.pdf`) -- therefore only some of those variables are presented here. 
